...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_11_12 = object : Migration(11, 12) {
            override fun migrate(db: SupportSQLiteDatabase) {
                try {
                    db.execSQL("ALTER TABLE players ADD COLUMN isSilencedThisRound INTEGER NOT NULL DEFAULT 0")
                } catch (e: Exception) {
                    // ignore if already exists
                }
            }
        ...
        private val MIGRATION_12_13 = object : Migration(12, 13) {
            override fun migrate(db: SupportSQLiteDatabase) {
                try {
                    db.execSQL("ALTER TABLE players ADD COLUMN wasBlockedLastNight INTEGER NOT NULL DEFAULT 0")
                } catch (e: Exception) {
                    // ignore if already exists
                }
            }
        ...
        private val MIGRATION_13_14 = object : Migration(13, 14) {
            override fun migrate(db: SupportSQLiteDatabase) {
                try {
                    db.execSQL("ALTER TABLE players ADD COLUMN isSabotaged INTEGER NOT NULL DEFAULT 0")
                } catch (e: Exception) {
                    // ignore if already exists
                }
            }
        ...
        private val MIGRATION_16_17 = object : Migration(16, 17) {
            override fun migrate(db: SupportSQLiteDatabase) {
                try {
                    db.execSQL("ALTER TABLE players ADD COLUMN challengeCount INTEGER NOT NULL DEFAULT 0")
                } catch (e: Exception) {
                    // ignore if already exists
                }
            }
        ...
        private val MIGRATION_17_18 = object : Migration(17, 18) {
            override fun migrate(db: SupportSQLiteDatabase) {
                try {
                    db.execSQL("ALTER TABLE players ADD COLUMN mustDieThisNight INTEGER NOT NULL DEFAULT 0")
                } catch (e: Exception) {
                    // ignore if already exists
                }
            }
            ...
            return INSTANCE ?: synchronized(this) {
                val instance = Room.databaseBuilder(
                    ...
                    .addMigrations(
                        ...
                        MIGRATION_13_14, MIGRATION_16_17, MIGRATION_17_18
                    )
