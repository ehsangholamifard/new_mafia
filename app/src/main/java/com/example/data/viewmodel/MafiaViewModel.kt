...
class MafiaViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _lastMoveCards = MutableStateFlow(
        listOf(
            LastMoveCard(1, "شلیک نهایی 🔫", "در اول شب به جای مافیا این شخص شلیک می کند."),
            LastMoveCard(2, "مسیر سبز 🟢", "فردی که مسیر سبز بگیرد به هیچ عنوان فردا در دفاعیه نمی رود."),
            LastMoveCard(3, "فرش قرمز 🔴", "فردی که فرش قرمز بگیرد فردا مستقیم به دفاعیه می رود."),
            LastMoveCard(4, "دروغ سیزده 🤥", "یک دروغ درباره خودش می گوید و گرداننده بازی تایید می کند."),
            LastMoveCard(5, "افشای نقش 🔍", "این شخص یک نفر از بازیکنان را انتخاب می کند و گرداننده نقش آن شخص را برای همه افشا می کند."),
            LastMoveCard(6, "خداحافظی کن 👋", "در بازی هیچ اتفاقی رخ نمی دهد و به ادامه بازی می پردازیم."),
            LastMoveCard(7, "بی خوابی 🌅", "شب نمی شود و مستقیم به روز بعد می رویم."),
            LastMoveCard(8, "ذهن زیبا 🧠", "اگر نقش کسی را دقیق حدس بزند در بازی می ماند."),
            LastMoveCard(9, "اعلام حضور 📢", "اگر رییس مافیا در بازی باشد توسط گرداننده اعلام می شود."),
            LastMoveCard(10, "روز محاکمه ⚖️", "فردا به محض اینکه روز شود رای گیری می شود و صحبتی انجام نمی شود."),
            LastMoveCard(11, "شهر در امان 🛡️", "امشب در شب هر شهروندی به هر دلیلی کشته شود از بازی خارج نمی شود حتی اگر کلانتر و یا حرفه ای اشتباه بزنند."),
            LastMoveCard(12, "روز جشن مافیا 🎉", "فردا توی روز هیچکس از بازی بیرون نمی رود."),
            LastMoveCard(13, "روز سکوت 🤫", "یک نفر را انتخاب می کند و این شخص فردا سکوت است."),
            LastMoveCard(14, "افشای هویت 👤", "نقش این شخص توسط گرداننده اعلام می شود."),
            LastMoveCard(15, "نبش قبر ⚰️", "اگر کسی از بازی بیرون رفته به انتخاب این شخص نقشش گفته می شود."),
            LastMoveCard(16, "سر شماری 📊", "تعداد مافیا و تعداد شهروند مانده در بازی اعلام می شود."),
            LastMoveCard(17, "تسخیر روح 👻", "یک نفر را انتخاب کن و فقط به گرداننده بگو و آن بازیکن در بازی هست اما واقعا حذف شده نه قابلیتی دارد نه توی آمار هست و نه رای او شمرده میشه."),
            LastMoveCard(18, "سرگیجه 🌀", "به صورت پنهانی یک نفر رو به گرداننده بگو این شخص ۲۴ ساعت از نقشش نمی تواند استفاده کند."),
            LastMoveCard(19, "شانس آوردی 🍀", "از بازی خارج نمی شوی و در بازی می مانی."),
            LastMoveCard(20, "بخت و اقبال 🎲", "یک نفر را انتخاب می کند و گرداننده بین این دو بازیکن قرعه مرگ میاندازد و کسی که ببرد تو بازی می ماند."),
            LastMoveCard(21, "سکوت بره ها 🐑", "دو نفر را انتخاب کن و آن دو بازیکن فردا حق صحبت کردن ندارن."),
            LastMoveCard(22, "تغییر چهره 🎭", "کسی که از بازی بیرون می رود نقشش را با یکی از بازیکنان به صورت کامل عوض می کند و آن بازیکن با نقش جدید ادامه می دهد."),
            LastMoveCard(23, "حذف یا حقیقت ❓", "یک بازیکن را انتخاب می کند و آن شخص بین حذف و یا حقیقت انتخاب می کند. اگر حذف انتخاب کند از بازی حذف می شود و اگر حقیقت انتخاب کند از او یک سوال می پرسد و باید درست جواب دهد."),
            LastMoveCard(24, "پرسش و پاسخ 💬", "فردا هرکس حق دارد از یک سوال از کس دیگری بپرسد و آن شخص پاسخ دهد و هیچکس حق صحبت دیگری ندارد."),
            LastMoveCard(25, "دستبند 🔗", "بازیکن اخراجی با کارت دستبند هرکس را نشان کند توانمندی های ان شب را از وی میگیرد."),
            LastMoveCard(26, "وصیت 📜", "شخص خارج شده از بازی جمله ایی به گرداننده بازی میگوید که به یکی از بازیکنان انتقال دهد.")
        )
    )
